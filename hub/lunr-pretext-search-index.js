...
},
{
  ...
  "number": "11",
  "title": "",
  "body": "   Start with the <section> template . Give the section the title Product Rule Reading Questions and delete the two <subsection> elements and the <conclusion> . We will only need the <introduction> and the <exercises> for this activity.      Replace the section's <introduction> with a short paragraph explaining that learners should answer the questions before class and use the feedback to review.    Possible introduction  <introduction> <p> Use this short reading check to make sure you recognize the product rule, can distinguish it from nearby derivative rules, and can identify where it applies. <\/p> <\/introduction>    "
},
{
