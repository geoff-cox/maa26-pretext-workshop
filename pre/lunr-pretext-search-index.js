...
},
{
  ...
  "body": " 4:20-4:35 PreTeXt.Plus   For today's workshop, everyone works inside pretext.plus , a browser-based editor for PreTeXt that needs nothing installed. You'll make a free account, create a project, and get oriented to the editor. By the end of this phase, you should have an empty project open and be ready to paste in content.    Create your account     Go to pretext.plus and click Sign up . Use an email you can check right now because there's a confirmation step.    Confirm your email, then log in.       Create your first project     Click Projects in the top nav, then the blue New project button.    Give it a title. Let's call it Calculus 1 Syllabus . Then click Create .    Click the gray Edit button on your new project. The editor opens with PreTeXt source on the left and a live preview on the right.       Learn the rebuild rhythm  The preview does not update automatically. After every edit, you need to rebuild.    Click the green Rebuild button at the top right of the preview, or  Press Ctrl + S (this also saves your work).     The rhythm is: Edit → Rebuild → Preview. You'll repeat that cycle dozens of times this afternoon. It becomes automatic within about ten minutes.    Getting Oriented  Before we start editing, take thirty seconds to notice:    The source panel on the left is where you type. It's PreTeXt XML, and we'll get to what that means in the next section.  The preview panel on the right is what your readers will see.  There's a short starter document already loaded. This is your sandbox. You can modify the non- <tag> content and rebuild it to see the changes.    You're ready. On to the exercises.   "
},
{
...
},
{
  ...
  "body": " 4:35-5:00 Create a Syllabus   In the project you just created, we're going to build a syllabus together in five parts. A finished version lives here . Open it in a separate tab now so you can compare as you go.  Placeholders like ==YourName== are yours to fill in or leave alone; whichever helps you focus on the tags.   Pair up with a neighbor. With a room this size, your neighbor is faster than I am. Ask them first; ask me if you're both stuck.       Part 1. Subsection Structure   Subsection Structure   Complete the following to setup the general structure of the syllabus.     Delete all but the <section> tags in your PreTeXt.Plus project. Then paste the four empty subsections with titles between <section> and <\/section> .      Now, update the <title> for each subsection to reflect its content. Then rebuild. You should see the titles appear in the preview and the structure take shape.    If you get stuck...  <section> <title>Calculus I Syllabus<\/title> <subsection> <title>Course and Instructor Information<\/title> <\/subsection> <subsection> <title>Course Description<\/title> <\/subsection> <subsection> <title>Grading Policy<\/title> <\/subsection> <subsection> <title>Schedule<\/title> <\/subsection> <\/section>          Part 2. Course and Instructor Information   Course Information   Complete the following tasks to build the course information section.     The Course Information will be your first subsection . Paste the text below between its <subsection> and <\/subsection> tags.  <p> Course: ==CourseName==, ==Term== Instructor: ==YourName== Email: ==yourname@example.edu== Office: ==OfficeLocation== Office Hours: ==OfficeHours== Lecture: ==MeetingTime==, ==Room== Course Website: ==CanvasURL== <\/p>  Rebuild, you should see all the lines run together as a single paragraph.      Now convert this into a formatted bulleted (unordered) list using:   <ul> , <li> to turn each line into a list item   <c> around the email address   <url> for the course website  Rebuild to see the transformation and verify that it resembles the target syllabus .    If you get stuck...  <subsection> <title>Course and Instructor Information<\/title> <p> <ul> <li>Course: ==CourseName==, ==Term==<\/li> <li>Instructor: ==YourName==<\/li> <li>Email: <c>==yourname@example.edu==<\/c><\/li> <li>Office: ==OfficeLocation==<\/li> <li>Office Hours: ==OfficeHours==<\/li> <li>Lecture: ==MeetingTime==, ==Room==<\/li> <li>Course Website: <url href=\"==URL==\">Canvas<\/url><\/li> <\/ul> <\/p> <p> The best way to reach me outside of office hours is by email. I aim to reply within one business day. <\/p> <\/subsection>          Part 3. Course Description   Course Description   Complete the following tasks to build the course description section.     The \"Course Description\" will go in the next subsection . Paste the block of code below into your project, then rebuild. Two chunks of prose will collapse into one undivided wall of text, with math expressions appearing as plain characters.  <p> Calculus I is a first course in differential calculus. We develop the concept of the limit from scratch, use it to give a precise definition of the derivative, and spend most of the semester learning to compute and apply derivatives. The course closes with an introduction to integration and the Fundamental Theorem of Calculus, which connects the two main ideas of the subject. By the end of the course, a successful student will be able to differentiate polynomials like p(x) = x^3 - 2x + 1, exponentials like e^x, logarithms like ln(x), and trigonometric functions like sin(x) and cos(x). They will also evaluate limits, apply the derivative to problems involving rates of change and optimization, and interpret the definite integral as a signed area. <\/p>      Give this text proper structure and rendered math using:   <p> split into two separate paragraphs   <m> around each math expression   <em> on the word Prerequisites   Try rebuilding after each change to watch the math snap into place one expression at a time.  After the last rebuild, verify that it resembles the target syllabus .    If you get stuck...  <subsection> <title>Course Description<\/title> <p> Calculus I is a first course in differential calculus. We develop the concept of the limit from scratch, use it to give a precise definition of the derivative, and spend most of the semester learning to compute and apply derivatives. The course closes with an introduction to integration and the Fundamental Theorem of Calculus, which connects the two main ideas of the subject. <\/p> <p> By the end of the course, a successful student will be able to differentiate polynomials like p(x) = x^3 - 2x + 1, exponentials like e^x, logarithms like ln(x), and trigonometric functions like sin(x) and cos(x). They will also evaluate limits, apply the derivative to problems involving rates of change and optimization, and interpret the definite integral as a signed area. <\/p> <\/subsection>          Part 4. Graded Work   Graded Work   Complete the following tasks to build the graded work section. This one has two transformations: a description list for the policies, and a small table for the grade weights.     Paste this into your third subsection , then rebuild. Six grading components will appear as one undivided block of text.  <p> Homework: 20 percent. Due Sundays at 11:59 pm on Canvas. Collaborate freely, but write solutions in your own words. Late work accepted up to 48 hours late at a 20 percent penalty; lowest two scores dropped. Quizzes: 10 percent. Short biweekly quizzes covering the recent material. Midterm 1: 20 percent. Closed book, closed notes, one handwritten reference sheet permitted. Midterm 2: 20 percent. Same format as Midterm 1. Final exam: 30 percent. Cumulative. Time and room set by the registrar. Grade cutoffs: At most A at 90 percent, B at 80, C at 70, D at 60. Cutoffs may be lowered at the end of the term but will never be raised. <\/p>      Turn the six components into a labeled description list using:   <dl> with <title> inside each <li>   Each component name (without the percentage) goes in the <title> ; the description goes in a <p> . Rebuild.    If you get stuck...  <p> <dl> <li> <title>Homework<\/title> <p> Due Sundays at 11:59 pm on Canvas. Collaborate freely, but write solutions in your own words. Late work accepted up to 48 hours late at a 20 percent penalty; lowest two scores dropped. <\/p> <\/li> <li> <title>Quizzes<\/title> <p> Short biweekly quizzes covering the recent material. <\/p> <\/li> <li> <title>Midterm 1<\/title> <p> Closed book, closed notes, one handwritten reference sheet permitted. <\/p> <\/li> <li> <title>Midterm 2<\/title> <p> Same format as Midterm 1. <\/p> <\/li> <li> <title>Final Exam<\/title> <p> Cumulative. Time and room set by the registrar. <\/p> <\/li> <li> <title>Grade Cutoffs<\/title> <p> At most A at 90 percent, B at 80, C at 70, D at 60. Cutoffs may be lowered at the end of the term but will never be raised. <\/p> <\/li> <\/dl> <\/p>      Pull the grade weights out of the list and display them as a compact two-column table. Add a <tabular> directly above the <dl> using:  <tabular> as the container  <row> for each component  <cell> for the name and the percentage  Rebuild.  After the last rebuild, verify that it resembles the target syllabus .    If you get stuck...  <subsection> <title>Graded Work<\/title> <tabular> <row> <cell>Homework<\/cell> <cell>20%<\/cell> <\/row> <row> <cell>Quizzes<\/cell> <cell>10%<\/cell> <\/row> <row> <cell>Midterm 1<\/cell> <cell>20%<\/cell> <\/row> <row> <cell>Midterm 2<\/cell> <cell>20%<\/cell> <\/row> <row> <cell>Final Exam<\/cell> <cell>30%<\/cell> <\/row> <\/tabular> <p> <dl> <li> <title>Homework<\/title> <p> Due Sundays at 11:59 pm on Canvas. Collaborate freely, but write solutions in your own words. Late work accepted up to 48 hours late at a 20 percent penalty; lowest two scores dropped. <\/p> <\/li> <li> <title>Quizzes<\/title> <p> Short biweekly quizzes covering the recent material. <\/p> <\/li> <li> <title>Midterm 1<\/title> <p> Closed book, closed notes, one handwritten reference sheet permitted. <\/p> <\/li> <li> <title>Midterm 2<\/title> <p> Same format as Midterm 1. <\/p> <\/li> <li> <title>Final Exam<\/title> <p> Cumulative. Time and room set by the registrar. <\/p> <\/li> <li> <title>Grade Cutoffs<\/title> <p> At most A at 90 percent, B at 80, C at 70, D at 60. Cutoffs may be lowered at the end of the term but will never be raised. <\/p> <\/li> <\/dl> <\/p> <\/subsection>          Part 5. Course Schedule   Course Schedule   The last section, and the most dramatic transformation of the day. Tables are verbose, so this time we'll hand you a working <tabular> and walk through styling it together. Follow along as we go.     Paste this block into your last subsection , then rebuild. You'll see a plain, unstyled sixteen-row table.  <tabular> <row> <cell><p>Week<\/p><\/cell><cell><p>Dates<\/p><\/cell> <cell><p>Topics<\/p><\/cell> <cell><p>Reading<\/p><\/cell> <\/row> <row> <cell>1<\/cell><cell>Aug 25-Aug 29<\/cell> <cell>Introduction; average\/instantaneous velocity<\/cell> <cell>1.1<\/cell> <\/row> <row> <cell>2<\/cell><cell>Sep 1-Sep 5<\/cell> <cell>The limit of a function; limit laws<\/cell> <cell>1.2<\/cell> <\/row> <row> <cell>3<\/cell><cell>Sep 8-Sep 12<\/cell> <cell>Continuity; limits at infinity<\/cell> <cell>1.3, 1.4<\/cell> <\/row> <row> <cell>4<\/cell><cell>Sep 15-Sep 19<\/cell> <cell>Definition of the derivative<\/cell> <cell>2.1, 2.2<\/cell> <\/row> <row> <cell>5<\/cell><cell>Sep 22-Sep 26<\/cell> <cell>Midterm 1<\/cell> <cell><\/cell> <\/row> <row> <cell>6<\/cell><cell>Sep 29-Oct 3<\/cell> <cell>Product\/quotient rules<\/cell> <cell>2.4, 2.5<\/cell> <\/row> <row> <cell>7<\/cell><cell>Oct 6-Oct 10<\/cell> <cell>The chain rule<\/cell> <cell>2.6<\/cell> <\/row> <row> <cell>8<\/cell><cell>Oct 13-Oct 17<\/cell> <cell>Implicit differentiation; inverse functions<\/cell> <cell>2.7, 2.8<\/cell> <\/row> <row> <cell>9<\/cell><cell>Oct 20-Oct 24<\/cell> <cell>Related rates; linear approximation<\/cell> <cell>3.1, 3.2<\/cell> <\/row> <row> <cell>10<\/cell><cell>Oct 27-Oct 31<\/cell> <cell>Midterm 2<\/cell> <cell><\/cell> <\/row> <row> <cell>11<\/cell><cell>Nov 3-Nov 7<\/cell> <cell>Increasing\/decreasing; Concavity<\/cell> <cell>3.4, 3.5<\/cell> <\/row> <row> <cell>12<\/cell><cell>Nov 10-Nov 14<\/cell> <cell>Optimization<\/cell> <cell>3.6<\/cell> <\/row> <row> <cell>13<\/cell><cell>Nov 17-Nov 21<\/cell> <cell>L'Hopital's rule; antiderivatives<\/cell> <cell>3.7, 4.1<\/cell> <\/row> <row> <cell>14<\/cell><cell>Dec 1-Dec 5<\/cell> <cell>The definite integral; Riemann sums<\/cell> <cell>4.2, 4.3<\/cell> <\/row> <row> <cell>15<\/cell><cell>Dec 8-Dec 12<\/cell> <cell>Fundamental Theorem of Calculus; review<\/cell> <cell>4.4<\/cell> <\/row> <row> <cell>16<\/cell><cell>Dec 16<\/cell> <cell>Final Exam, 8:00-10:00 am<\/cell> <cell>Cumulative<\/cell> <\/row> <\/tabular>      Now we'll style it together, one change at a time. Rebuild after each step to see the effect.     Mark the first row as a header by adding header=\"yes\" to its <row> tag.    Add borders by setting top=\"minor\" , bottom=\"minor\" , left=\"minor\" , and right=\"minor\" on the <tabular> tag.    Control column widths by adding four <col\/> elements before the first row. Try width=\"9%\" , width=\"40%\" , width=\"36%\" , and width=\"15%\" . Center the first two with halign=\"center\" .    Highlight the exam weeks by wrapping their topic cells in <alert> .     Compare your result to the target syllabus .    If you get stuck...  <subsection xml:id=\"sec-schedule\"> <title>Course Schedule<\/title> <p> Section numbers refer to <em>Active Calculus<\/em>. Topic coverage may shift by a class or two depending on pacing. <\/p> <tabular top=\"minor\" bottom=\"minor\" left=\"minor\" right=\"minor\"> <col width=\"9%\" halign=\"center\"\/> <col width=\"40%\" halign=\"center\"\/> <col width=\"36%\"\/> <col width=\"15%\"\/> <row header=\"yes\"> <cell><p>Week<\/p><\/cell><cell><p>Dates<\/p><\/cell> <cell><p>Topics<\/p><\/cell> <cell><p>Reading<\/p><\/cell> <\/row> <row> <cell>1<\/cell><cell>Aug 25-Aug 29<\/cell> <cell>Introduction; average\/instantaneous velocity<\/cell> <cell>1.1<\/cell> <\/row> <row> <cell>2<\/cell><cell>Sep 1-Sep 5<\/cell> <cell>The limit of a function; limit laws<\/cell> <cell>1.2<\/cell> <\/row> <row> <cell>3<\/cell><cell>Sep 8-Sep 12<\/cell> <cell>Continuity; limits at infinity<\/cell> <cell>1.3, 1.4<\/cell> <\/row> <row> <cell>4<\/cell><cell>Sep 15-Sep 19<\/cell> <cell>Definition of the derivative<\/cell> <cell>2.1, 2.2<\/cell> <\/row> <row> <cell>5<\/cell><cell>Sep 22-Sep 26<\/cell> <cell><alert>Midterm 1<\/alert><\/cell> <cell><\/cell> <\/row> <row> <cell>6<\/cell><cell>Sep 29-Oct 3<\/cell> <cell>Product\/quotient rules<\/cell> <cell>2.4, 2.5<\/cell> <\/row> <row> <cell>7<\/cell><cell>Oct 6-Oct 10<\/cell> <cell>The chain rule<\/cell> <cell>2.6<\/cell> <\/row> <row> <cell>8<\/cell><cell>Oct 13-Oct 17<\/cell> <cell>Implicit differentiation; inverse functions<\/cell> <cell>2.7, 2.8<\/cell> <\/row> <row> <cell>9<\/cell><cell>Oct 20-Oct 24<\/cell> <cell>Related rates; linear approximation<\/cell> <cell>3.1, 3.2<\/cell> <\/row> <row> <cell>10<\/cell><cell>Oct 27-Oct 31<\/cell> <cell><alert>Midterm 2<\/alert><\/cell> <cell><\/cell> <\/row> <row> <cell>11<\/cell><cell>Nov 3-Nov 7<\/cell> <cell>Increasing\/decreasing; Concavity<\/cell> <cell>3.4, 3.5<\/cell> <\/row> <row> <cell>12<\/cell><cell>Nov 10-Nov 14<\/cell> <cell>Optimization<\/cell> <cell>3.6<\/cell> <\/row> <row> <cell>13<\/cell><cell>Nov 17-Nov 21<\/cell> <cell>L'Hopital's rule; antiderivatives<\/cell> <cell>3.7, 4.1<\/cell> <\/row> <row> <cell>14<\/cell><cell>Dec 1-Dec 5<\/cell> <cell>The definite integral; Riemann sums<\/cell> <cell>4.2, 4.3<\/cell> <\/row> <row> <cell>15<\/cell><cell>Dec 8-Dec 12<\/cell> <cell>Fundamental Theorem of Calculus; review<\/cell> <cell>4.4<\/cell> <\/row> <row> <cell>16<\/cell><cell>Dec 16<\/cell> <cell><alert>Final Exam, 8:00-10:00 am<\/alert><\/cell> <cell>Cumulative<\/cell> <\/row> <\/tabular> <p> <em>Note:<\/em> There is no class November 24–28 (Thanksgiving break). <\/p> <\/subsection>      "
},
{
  "id": "exr-subsec-structure",
  "level": "2",
  "url": "sec-guided-practice.html#exr-subsec-structure",
  "type": "Checkpoint",
  "number": "6",
  "title": "Subsection Structure.",
  "body": " Subsection Structure   Complete the following to setup the general structure of the syllabus.     Delete all but the <section> tags in your PreTeXt.Plus project. Then paste the four empty subsections with titles between <section> and <\/section> .      Now, update the <title> for each subsection to reflect its content. Then rebuild. You should see the titles appear in the preview and the structure take shape.    If you get stuck...  <section> <title>Calculus I Syllabus<\/title> <subsection> <title>Course and Instructor Information<\/title> <\/subsection> <subsection> <title>Course Description<\/title> <\/subsection> <subsection> <title>Grading Policy<\/title> <\/subsection> <subsection> <title>Schedule<\/title> <\/subsection> <\/section>    "
},
{
  "id": "exr-course-info",
  "level": "2",
