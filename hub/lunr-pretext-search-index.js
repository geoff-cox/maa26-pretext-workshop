...
},
{
  ...
  "body": " Course and Instructor Information    Course: ==CourseName==, ==Term==  Instructor: ==YourName==  Email: ==yourname@example.edu==  Office: ==OfficeLocation==  Office Hours: ==OfficeHours==, or by appointment  Lecture: ==MeetingTime==, ==Room==  Course Website: Canvas    The best way to reach me outside of office hours is by email. I aim to reply within one business day.  "
},
{
  "id": "sec-description",
  "level": "1",
